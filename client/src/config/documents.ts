...
export const DOCUMENTS: DocumentConfig[] = [
  ...
  },
  {
    ...
    description: 'Employment letter or experience certificate — one upload per employer',
    required: true,
  ...
  },
  {
    ...
    description: 'Degree, diploma, or academic certificate — one upload per institution',
    required: true,
